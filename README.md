...
### Backend Developer | Spring Boot | AWS | AI

사용자가 실제로 사용할 수 있는 서비스를 설계하고 개발하는 백엔드 개발자입니다.
...
| **AI** | ![Ollama](https://img.shields.io/badge/Ollama-000000?style=flat-square) |
...
### COBIP (Code-Based Interactive Practice)
